...
steal('/siteDispatch.js').then(function() {
    ...
    var nameModule = window.location.pathname.match(/\/page\/(\w*)\/.+/)[1];
    ...
    dispatch.Mechanisms = {
        /**
         * @attribute Mechanisms.Push
         * @parent AD_Client.SiteDispatch.Mechanisms
         * 
