...
/**
 *  appRAD generated setup script for the Test Interface container. 
 *
 *  The job of this code is to make sure the HTML DOM content required
 *  for the testunitTest_setup() is generated before it is called.
 */
...
(function() {
    ...
    var testunitTestRADSetup = function() {
        ...
        // place before the testunitTestSetup() is called.
        ...
        $.when(initProcess).done(function () {
            ...
            // keep this last:
            // publish a notification it's time to run testunitTestSetup()
            OpenAjax.hub.publish("ad.testunit.test.setup", {});
    ...
    var subscriptionID = OpenAjax.hub.subscribe('ad.testunit.test.radsetup',testunitTestRADSetup);
