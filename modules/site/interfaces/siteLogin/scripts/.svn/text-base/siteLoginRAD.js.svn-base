 ...
 *  for the siteLogin_setup() is generated before it is called.
 */
...
var siteLoginRADSetup = function(topic, data) {
    ...
    // publish a notification it's time to run siteLoginSetup()
...
var subscriptionID=OpenAjax.hub.subscribe('ad.site.login.radsetup',siteLoginRADSetup);
