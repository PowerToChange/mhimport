...
var appRADViewRead = new AD.App.Service({});
module.exports = appRADViewRead;
...
////---------------------------------------------------------------------
app.all('/appRAD/interface/views/read', viewStack, function(req, res, next) {
    // test using: http://localhost:8088/appRAD/interface/views/read?module=site&interface=email&view=email.ejs


    // By the time we get here, all the processing has taken place.
	totalCount++;
	
    logDump(req, 'finished view/read ['+totalCount+']');
