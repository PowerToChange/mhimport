...
/**
 *  appRAD generated setup script for the Portal Interface container. 
 *
 *  The job of this code is to make sure the HTML DOM content required
 *  for the appRADPortal_setup() is generated before it is called.
 */
...
(function() {
    ...
    var appRADPortalRADSetup = function() {
        ...
        $.when(initProcess).done(function () {
            ...
            OpenAjax.hub.publish("ad.appRAD.portal.setup", {});
    ...
    var subscriptionID = OpenAjax.hub.subscribe('ad.appRAD.portal.radsetup',appRADPortalRADSetup);
