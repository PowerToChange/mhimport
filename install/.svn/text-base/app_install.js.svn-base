 ...
 * ###copyDefaults
 *
 * Copy `/install/data/defaults.js`  to `/node_modules/defaults.js`
 * 
 */
//---------------------------------------------------------
var copyDefaults = function (req, res, next) {
    ...
    var destDir = __dirname + '/../node_modules/defaults.js';
...
app.all('/', function(req, res) {
    ...
    res.header('Location: /appDevInstall');
    res.send('Go to /appDevInstall');
...
app.all('/install/validateFile', function(req, res, next) {
    ...
    path.exists(pathToVerify, function (isThere) {
